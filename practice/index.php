        ...
        <header style="background-color: rgb(255, 255, 255)" class="shadow">
            <nav class="d-flex justify-content-between">
                ...
                if ($_SESSION['role'] == 'user') {
                    ...
                    <div class="d-flex align-items-center d-none d-md-block">
                        <ul class="list-group list-group-horizontal">
                            <li class="list-group-item">
                                <a href="pages/cart.php" class="mx-3 text-decoration-none">
                            ...
                            <li class="list-group-item">
                                <a href="pages/orders.php" class="mx-3 text-decoration-none">
                            ...
                            <li class="list-group-item">    
                                <a href="php/quit.php" class="mx-3 text-decoration-none">
                    ...
                    <div class="d-flex align-items-center mx-2 d-flex d-md-none">
                ...
                elseif ($_SESSION['role'] == 'admin') {
                    ...
                    <div class="d-flex align-items-center d-none d-md-block">
                        <ul class="list-group list-group-horizontal">
                            ...
                            <li class="list-group-item">
                                <a href="pages/new_book.html" class="mx-3 text-decoration-none">
                    ...
                    <div class="d-flex align-items-center d-none d-md-block">
                        <ul class="list-group list-group-horizontal">
                            <li class="list-group-item">
                                <a href="pages/login.html" class="mx-3 text-decoration-none">
                            ...
                            <li class="list-group-item">
                                <a href="pages/registrations.html" class="mx-3 text-decoration-none">
                    ...
                    if ($result) {
                        while ($user = mysqli_fetch_assoc($result)) {
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                                <div class="">
                                    <a href="pages/book_about.php?id=' . $user['id_book'] . '">
                                        <img src="' . $user['photo'] . '" class="img-fluid" style="width: 100%; height: 250px; object-fit: cover;">
                                    </a>
                                </div>
                                <div>
